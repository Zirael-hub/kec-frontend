...
export default function NewsSearchFilter({ q, setQ, category, setCategory, categories }: Props) {
  const cats = useMemo(()=>['Semua', ...categories], [categories])
  return (
